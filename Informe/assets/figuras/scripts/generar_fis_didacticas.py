#!/usr/bin/env python3
"""
Genera figuras didácticas para la sección de lógica difusa (Tema 2):
  - Informe/assets/figuras/d2/fig08a_conjuntos_borrosos.png
  - Informe/assets/figuras/d2/fig08b_numero_borroso_alpha.png
  - Informe/assets/figuras/d2/fig09_defuzzificacion_centroide.png
  - Informe/assets/figuras/d2/fig10_flujo_fis.png
  - Informe/assets/figuras/d2/fig11a_anfis_capas.png
  - Informe/assets/figuras/d2/fig11b_anfis_superficie.png
"""
...
OUT1A = "Informe/assets/figuras/d2/fig08a_conjuntos_borrosos.png"
OUT1B = "Informe/assets/figuras/d2/fig08b_numero_borroso_alpha.png"
OUT2 = "Informe/assets/figuras/d2/fig09_defuzzificacion_centroide.png"
OUT3 = "Informe/assets/figuras/d2/fig10_flujo_fis.png"
OUT4A = "Informe/assets/figuras/d2/fig11a_anfis_capas.png"
OUT4B = "Informe/assets/figuras/d2/fig11b_anfis_superficie.png"
...
def fig_conjuntos():
    ...
    ax.set_title("Conjuntos borrosos para PM2.5", fontsize=13, fontweight="bold")
    ...
    fig.tight_layout()
    fig.savefig(OUT1A, bbox_inches="tight")
    plt.close(fig)
...
def fig_numero_borroso_alpha():
    ...
    ax.set_title("Número borroso y corte alfa", fontsize=13, fontweight="bold")
...
def fig_defuzzificacion():
    ...
    ax1.set_title("A) Mamdani: agregación + centroide", fontsize=12.5, fontweight="bold")
    ...
    ax2.set_title("B) Sugeno/TSK: promedio ponderado", fontsize=12.5, fontweight="bold")
...
def fig_anfis_capas():
    ...
    fig.savefig(OUT4A, bbox_inches="tight")
    plt.close(fig)
...
def fig_anfis_superficie():
    ...
    ax.set_title("Superficie de salida ANFIS aprendida", fontsize=12.5, fontweight="bold", pad=10)
    ...
    fig.tight_layout()
    fig.savefig(OUT4B, bbox_inches="tight")
    plt.close(fig)
