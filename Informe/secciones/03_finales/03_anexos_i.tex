...
\input{assets/tablas/03_finales/03_anexos_i/anexo_checklist_calidad.tex}
...
\input{assets/tablas/03_finales/03_anexos_i/diccionario_extraccion.tex}


\clearpage
\VIUAnexoSection{Anexo III}{ane:d3_tabla_principal}
\subsection*{Tabla principal de evidencia cuantitativa D3}
\input{assets/tablas/02_cuerpo/04_estado_del_arte/d3/d3_tabla_principal_es.tex}

\subsection*{Frecuencia de métricas por grupos comparables core (desempeño)}
\input{assets/tablas/02_cuerpo/04_estado_del_arte/eval/eval_metricas_por_unidad_core_es.tex}

\clearpage
\VIUAnexoSection{Anexo IV}{ane:anexo_reglas_principales}
\subsection*{Base principal de 54 reglas del motor difuso}
\input{assets/tablas/03_finales/03_anexos_i/anexo_reglas_principales_54.tex}

\clearpage
\VIUAnexoSection{Anexo V}{ane:anexo_breakpoints_epa}
\subsection*{AQI Breakpoints EPA/AQS utilizados por el prototipo}
\input{assets/tablas/03_finales/03_anexos_i/anexo_breakpoints_epa_aqs.tex}
