\section{Diccionario operativo de la matriz de extracción}
\label{sec:anexo_diccionario_extraccion}
...
[entry=none,
 ...
 caption={Diccionario operativo de campos de \texttt{articles\_data\_extraction.csv}.}]{
  colspec = {X[0.9,j,m] X[1.8,j,m] X[4.0,j,m]},
  rowhead = 1,
  row{1} = {font=\bfseries},
  hlines
}
